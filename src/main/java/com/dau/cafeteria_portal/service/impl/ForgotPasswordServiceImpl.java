...
public class ForgotPasswordServiceImpl implements ForgotPasswordService {
    ...
    public String resetPassword(ResetPasswordRequest req) {
        ...
        OtpVerification otp = otpRepo.findByEmail(req.getEmail())
                .orElseThrow(() -> new RuntimeException("Please request a verification code first."));

        if (!otp.isVerified()) {
            throw new RuntimeException("Please verify your code before setting a new password.");
        }
